...
<main>
    <div class="dashboard">
        <div class="welcome-text">Welcome to the Staff Dashboard!</div>
        <div class="tasks">
            <h2>Staff Tasks</h2>
            <ul>
                <li>Review and approve user appointments.</li>
                <li>Generate blood test reports.</li>
                <li>Update staff profiles and information.</li>
